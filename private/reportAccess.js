...
const ACCESS = [
  ...
  },
  {
    ...
    reports: [
      ...
      { id: 'cayo-coco-septiembre-2026-corte-21', label: 'Septiembre 2026 · Corte 21', period: 'Septiembre 2026', file: 'cayo-coco-septiembre-2026-corte-21.html', score: 4.79, historicalScore: 4.14, reviews: 78, answered: null, positiveRate: 96.2, accent: '#285a47', category: 'Reportes mensuales de encuestas de Google', summary: 'Corte parcial al 21 de septiembre: 78 opiniones, promedio 4,79 y 96,2% de calificaciones positivas.' },
