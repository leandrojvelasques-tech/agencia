...
export default function ChangeRequestsDashboard() {
  ...
  const openNotification = (item) => {
    ...
    setNotification({ item, to: item.requester_email || '', subject, message, attachments: [] })
  }
