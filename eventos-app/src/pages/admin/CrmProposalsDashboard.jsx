...
export default function CrmProposalsDashboard() {
  ...
  const handleCopyLink = (proposal, id) => {
    const link = `${window.location.origin}${getProposalPublicPath(proposal)}`
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-3 pt-3 border-t border-gray-50">
                          ...
                          <div className="flex items-center gap-1 opacity-60 group-hover:opacity-100 transition-opacity">
                            ...
                            <button onClick={() => handleCopyLink(proposal, proposal.id)} className="text-gray-500 hover:bg-gray-100 p-1.5 rounded-md transition-colors relative" title="Copiar Enlace">
                            ...
                            <a href={getProposalPublicPath(proposal)} target="_blank" rel="noreferrer" className="text-gray-500 hover:bg-gray-100 p-1.5 rounded-md transition-colors" title="Vista Pública">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                  ...
                  <div className="flex items-center justify-between md:justify-end gap-6 border-t md:border-t-0 border-[var(--color-deep-green)]/5 pt-4 md:pt-0">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      {/* Copy link */}
                      <button
                        onClick={() => handleCopyLink(proposal, proposal.id)}
                      ...
                      {/* View public */}
                      <a
                        href={getProposalPublicPath(proposal)}
                        target="_blank"
                        rel="noreferrer"
