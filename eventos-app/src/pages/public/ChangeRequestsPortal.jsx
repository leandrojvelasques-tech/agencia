...
const initialForm = { requester_name: '', requester_email: '', title: '', request_type: 'improvement', affected_area: '', description: '', expected_result: '', priority: 'normal' }
